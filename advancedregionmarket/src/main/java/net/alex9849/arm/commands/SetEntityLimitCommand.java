...
public class SetEntityLimitCommand implements BasicArmCommand {
    ...
    public boolean runCommand(CommandSender sender, Command cmd, String commandsLabel, String[] args, String allargs) throws InputException {
        ...
        EntityLimitGroup entityLimitGroup = AdvancedRegionMarket.getARM().getEntityLimitGroupManager().getEntityLimitGroup(args[2]);
            ...
            if (this.rootCommand.startsWith(args[0])) {
                if(player.hasPermission(Permission.ADMIN_SET_ENTITYLIMIT)) {
                    if(args.length == 1) {
                        ...
                        returnme.addAll(AdvancedRegionMarket.getARM().getEntityLimitGroupManager().tabCompleteEntityLimitGroups(args[2]));
                    }
                }
            }
        }
