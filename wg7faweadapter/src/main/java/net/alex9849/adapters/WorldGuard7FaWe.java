...
public class WorldGuard7FaWe extends WorldGuardInterface {
    private static List<WG7RegionFaWe> createdRegions = new ArrayList<WG7RegionFaWe>();
    ...
    public WG7RegionFaWe getRegion(World world, WorldGuardPlugin worldGuardPlugin, String regionID) {
    ...
    public WGRegion createRegion(String regionID, Location pos1, Location pos2, WorldGuardPlugin worldGuardPlugin) {
        ...
        WG7RegionFaWe returnRegion = getUniqueRegion(protectedRegion);
        return returnRegion;
    }
    ...
    public void addToRegionManager(WGRegion region, World world, WorldGuardPlugin worldGuardPlugin) {
        WG7RegionFaWe wg6Region = (WG7RegionFaWe) region;
    ...
    public void removeFromRegionManager(WGRegion region, World world, WorldGuardPlugin worldGuardPlugin) {
        WG7RegionFaWe wg7Region = (WG7RegionFaWe) region;
    ...
    private WG7RegionFaWe getUniqueRegion(ProtectedRegion protectedRegion) {
        for(WG7RegionFaWe wgRegion : createdRegions) {
            if(wgRegion.getRegion() == protectedRegion) {
                return wgRegion;
            }
        }
        WG7RegionFaWe wg7Region = new WG7RegionFaWe(protectedRegion);
        return wg7Region;
    }
