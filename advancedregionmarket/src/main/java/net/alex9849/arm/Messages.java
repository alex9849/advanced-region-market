...
public class Messages {
    ...
    private static void updateDefauts() {
        ...
        fileUpdated |= YamlFileManager.addDefault(config, "Messages.SecondsSingular", "Second");
        fileUpdated |= YamlFileManager.addDefault(config, "Messages.MinutesSingular", "Minute");
        fileUpdated |= YamlFileManager.addDefault(config, "Messages.HoursSingular", "Hour");
        fileUpdated |= YamlFileManager.addDefault(config, "Messages.DaysSingular", "Day");
