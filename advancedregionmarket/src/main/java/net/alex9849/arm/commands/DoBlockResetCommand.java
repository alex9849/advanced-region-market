...
public class DoBlockResetCommand extends BasicArmCommand {
    ...
    private final String regex_massaction = "(?i)doblockreset re:[^;\n ]+ (false|true)";
    private final List<String> usage = new ArrayList<>(Arrays.asList("doblockreset [REGION] [true/false]", "doblockreset re:[REGIONKIND] [true/false]"));
    ...
    public boolean runCommand(CommandSender sender, Command cmd, String commandsLabel, String[] args, String allargs) throws InputException {
        ...
        String sendmessage = Messages.PREFIX + "&6DoBlockReset " + Messages.convertEnabledDisabled(boolsetting) + " &6for " + selectedName + "&6!";
