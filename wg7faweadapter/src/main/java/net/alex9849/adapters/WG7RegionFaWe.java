...
public class WG7RegionFaWe extends WGRegion {

    private ProtectedRegion region;

    WG7RegionFaWe(ProtectedRegion region) {
        this.region = region;
    }
    ...
    public boolean equals(WGRegion wgRegion) {
        WG7RegionFaWe wg7Region = (WG7RegionFaWe) wgRegion;
    ...
    public WGRegion getParent() {
        if(this.getRegion().getParent() != null) {
            return new WG7RegionFaWe(this.getRegion().getParent());
        } else {
            return null;
        }
