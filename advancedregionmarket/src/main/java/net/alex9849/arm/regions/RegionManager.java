                                    ...
                                    if(region != null) {
                                                        ...
                                                        for(int j = 0; j < subregionsignsloc.size(); j++) {
                                                            ...
                                                            if (subregionRegiontype.equalsIgnoreCase("rentregion")){
                                                                ...
                                                                Region armregion = new RentRegion(subWGRegion, regionWorld, subregionsigns, subregPrice, subregIsSold, ArmSettings.isSubregionAutoReset(), subregIsHotel, ArmSettings.isSubregionBlockReset(), RegionKind.SUBREGION, null,
                                                                        1, ArmSettings.isAllowSubRegionUserReset(), subregpayedtill, subregmaxRentTime, subregrentExtendPerClick, new ArrayList<Region>(), 0);
                                                                subregions.add(armregion);
                                                            } else if (subregionRegiontype.equalsIgnoreCase("sellregion")){
                                                                Region armregion = new SellRegion(subWGRegion, regionWorld, subregionsigns, subregPrice, subregIsSold, ArmSettings.isSubregionAutoReset(), subregIsHotel, ArmSettings.isSubregionBlockReset(), RegionKind.SUBREGION, null, 1, ArmSettings.isAllowSubRegionUserReset(), new ArrayList<Region>(), 0);
                                                                subregions.add(armregion);
                                                                ...
                                                                Region armregion = new ContractRegion(subWGRegion, regionWorld, subregionsigns, subregPrice, subregIsSold, ArmSettings.isSubregionAutoReset(), subregIsHotel, ArmSettings.isSubregionBlockReset(), RegionKind.SUBREGION, null, 1, ArmSettings.isAllowSubRegionUserReset(), subregextendTime, subregpayedtill, subregterminated, new ArrayList<Region>(), 0);
                                                                subregions.add(armregion);
                                                            }
                                        ...
                                        if (regiontype.equalsIgnoreCase("rentregion")){
                                            ...
                                            Region armregion = new RentRegion(region, regionWorld, regionsigns, price, sold, autoreset, allowonlynewblocks, doBlockReset, regionKind, teleportLoc,
                                                    lastreset, true, payedtill, maxRentTime, rentExtendPerClick, subregions, 2);
                                            loadedRegions.add(armregion);
                                        } else if (regiontype.equalsIgnoreCase("sellregion")){
                                            Region armregion = new SellRegion(region, regionWorld, regionsigns, price, sold, autoreset, allowonlynewblocks, doBlockReset, regionKind, teleportLoc, lastreset, true, subregions, 2);
                                            loadedRegions.add(armregion);
                                            ...
                                            Region armregion = new ContractRegion(region, regionWorld, regionsigns, price, sold, autoreset, allowonlynewblocks, doBlockReset, regionKind, teleportLoc, lastreset, true,extendTime, payedtill, terminated, subregions, 2);
                                            loadedRegions.add(armregion);
                                        }
                                    }
                                }
