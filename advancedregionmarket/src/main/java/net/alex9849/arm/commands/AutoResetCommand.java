...
public class AutoResetCommand extends BasicArmCommand {
    ...
    private final String regex_massaction = "(?i)autoreset re:[^;\n ]+ (false|true)";
    private final List<String> usage = new ArrayList<>(Arrays.asList("autoreset [REGION] [true/false]", "autoreset re:[REGIONKIND] [true/false]"));
