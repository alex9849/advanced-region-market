...
public class Messages {
    ...
    private static void updateDefauts() {
        ...
        fileUpdated |= YamlFileManager.addDefault(config,"Messages.ResetRegionCooldownError", "&7You have to wait&6 %remainingusersellcooldown% &7days till you can reset your region again");
