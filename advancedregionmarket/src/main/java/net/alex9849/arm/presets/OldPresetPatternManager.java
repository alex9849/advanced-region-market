...
public class OldPresetPatternManager {
    ...
    public static void loadPresetPatterns() {
        OldPresetPatternManager.setConfig();
    ...
    private static void setConfig(){
        ...
        OldPresetPatternManager.presetConfig = YamlConfiguration.loadConfiguration(presetsconfigdic);
    }
    ...
    public static void savePresetPatternConf() {
        ...
        try {
            OldPresetPatternManager.presetConfig.save(presetPatternConfigDic);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
